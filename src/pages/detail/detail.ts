...
export class DetailPage {
  ...
  loadData(id:number){
    this.myHttp
    .sendRequest("http://127.0.0.1/maseratiAPP/data/product/details.php?lid="+id)
  ...
  addToCart(){
    this.myHttp
    .sendRequest("http://127.0.0.1/maseratiAPP/data/cart/add.php?buyCount=1&lid="+this.productId)
    .subscribe((result:any)=>{
      console.log(result);
      if(result)
      {
